...
\quote{Architecte ouvert, développeur polyglotte passionné, agiliste convaincu}
...
\section{Expérience}
\cventry{2012~–~\ldots}{Architecte Logicielle}{Linagora}{Puteaux}{}{Co-lead d'une équipe de 8, Développement de solutions de communication; création de projets R\&D avec recherche de partenariats; Organisation de MeetUPs; animation de conférences internes et externes; missions d'expertise \& conseil sur le développement, opérations et intégration; élaboration d'une architecture pour PaaS.}
\cventry{2011}{Architecte Logicielle Junior}{ProxiAD}{Paris}{}{Architecture, conception et développement d'un moteur de calculs boursiers distribué et haute disponibilité en Java (prototype en Scala) et utilisant une DSL Xtext; lead technique sur 2 juniors.}
...
\section{Formations}
\cventry{2006~–~2007}{M1 Informatique : Systèmes et Applications Repartis et en Temps Réel}{Université Pierre \& Marie Curie}{Paris}{}{}
...
\section{Loisirs}
\cvlistdoubleitem{Logiciels libres}{MeetUPs}
\cvlistdoubleitem{Sérendipité}{Jeux de rôles}
\cvlistdoubleitem{Typograpie}{Calisthenie}
